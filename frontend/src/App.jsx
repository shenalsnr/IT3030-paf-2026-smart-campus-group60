                        ...
                        <div className="flex justify-between h-16 items-center">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-2xl font-black tracking-tighter text-gray-800">
                                    Swift<span className="text-blue-600">Fix</span>
                                </span>
                            </div>
                            ...
                            <div className="flex space-x-2">
                                ...
                                {/* ✅ USER SIDE TICKETS */}
                                <Link to="/tickets" className="flex items-center gap-1.5 px-3 py-2 rounded-md text-sm font-medium text-gray-600 hover:text-red-600 hover:bg-red-50 transition-all">
