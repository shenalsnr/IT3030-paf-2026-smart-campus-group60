...
import { LayoutDashboard, CheckCircle, XCircle, Users, Calendar, Clock, MessageSquareText, Settings, Ticket } from 'lucide-react';
            ...
            <div className="flex justify-between items-center mb-8">
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-5 py-2.5 bg-red-50 border border-red-200 text-red-700 font-bold text-sm rounded-xl hover:bg-red-100 transition-colors shadow-sm"
                    >
                        <Ticket size={18} />
                        Manage Tickets
                    </button>
